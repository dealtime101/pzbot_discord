...
def load_config() -> Config:
    ...
    return Config(
        ...
        PZ_CONTROL_PS1=os.environ.get(
            "PZ_CONTROL_PS1",
            rf"{base}\pz_control.ps1"
        ),
        WORKSHOP_CHECK_PS1=os.environ.get(
            "WORKSHOP_CHECK_PS1",
            rf"{base}\pzbot_workshop_check.ps1"
        ),

        PZ_LOGSCAN_PS1=os.environ.get(
            "PZ_LOGSCAN_PS1",
            rf"{base}\pz_logscan.ps1"
        ),
        PZ_CONSOLE_LOG=os.environ.get(
            "PZ_CONSOLE_LOG",
            rf"{base}\hh_saves\Zomboid\server-console.txt"
        ),
        DISCORD_BUGS_CHANNEL_ID=int(os.environ.get("DISCORD_BUGS_CHANNEL_ID", "0")),
        ...
        BOT_VERSION=os.environ.get("PZBOT_VERSION", "1.3.6").strip(),
    )
